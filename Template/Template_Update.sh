...
StopDebug=$Temp/DebugSHProcess
StopRunning=$Temp/RunningSHProcess
...
echo `DATE`	${0##*/}	Power_key >> $DetailLog
}
...
echo `DATE`	${0##*/}	Menu_key >> $DetailLog
}

Home_key()
{
input keyevent HOME;busybox usleep 300000
echo `DATE`	${0##*/}	Home_key >> $DetailLog
}
...
echo `DATE`	${0##*/}	Back_key >> $DetailLog
}
...
echo `DATE`	${0##*/}	Recent_key >> $DetailLog
}
...
ExistAttribution "text=\"$attribution\"" $instance
...
ExistAttribution "resource-id=\"$attribution\"" $instance
...
ExistAttribution "content-desc=\"$attribution\"" $instance
...
#please add action on here, if the attribution cannot be found, it will be performed
#echo `DATE`	${0##*/}	DragIntelligent	Fail >> $LogFile
#echo `DATE`	${0##*/}	DragIntelligent	Fail >> $DetailLog
...
LongPressByAttributionWithoutUpdateXML()
{
#${0##*/} > file name
#$1 > attribution
#$2 > instance, default value is: 1
...
ExistAttributionWithoutUpdateXML "\"$1\"" $instance
if test $centerX -ne -1
then

#please add action on here, if the attribution can be found, it will be performed
LongPress $centerX $centerY
echo `DATE`	${0##*/}	LongPressByAttributionWithoutUpdateXML	"$1" >> $DetailLog
else

#please add action on here, if the attribution cannot be found, it will be performed
echo `DATE`	${0##*/}	LongPressByAttributionWithoutUpdateXML	"$1"	Fail >> $LogFile
echo `DATE`	${0##*/}	LongPressByAttributionWithoutUpdateXML	"$1"	Fail >> $DetailLog
Screenshot
exit
fi
...
#please add action on here, if the attribution can be found, it will be performed
LongPress $centerX $centerY
echo `DATE`	${0##*/}	LongPressByAttribution	"$1" >> $DetailLog

else

#please add action on here, if the attribution cannot be found, it will be performed
echo `DATE`	${0##*/}	LongPressByAttribution	"$1"	Fail >> $LogFile
echo `DATE`	${0##*/}	LongPressByAttribution	"$1"	Fail >> $DetailLog
Screenshot
exit
fi
...
echo `DATE`	${0##*/}	HoldByAttribution	"$1" >> $DetailLog
else

#please add action on here, if the attribution cannot be found, it will be performed
echo `DATE`	${0##*/}	HoldByAttribution	"$1"	Fail >> $LogFile
echo `DATE`	${0##*/}	HoldByAttribution	"$1"	Fail >> $DetailLog
Screenshot
exit
fi
...
#uiautomator runtest CommonAction.jar -c com.fih.liguo.FindByText -e ResourceId $1 -e Text `echo "$2"|busybox sed -e "s/ /%20/g"` -e Instance $3
...
#Click Widget
ClickByAttribution "com.fihtdc.foxlauncher:id/menu_item_title" 1
...
TCRepeat=`cat $DetailLog|busybox fgrep ${0##*/}|busybox fgrep "Current Time"|busybox tail -1|busybox awk -F: '{print $NF}'`
...
#echo `DATE`	${0##*/}	F	$DurationRunTime >> $LogFile
#echo LogFail----TCFailReason: $1
...
LongPressByAttribution "com.android.contacts:id/deleteButton" 1
...
0)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/zero" 1;;
1)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/one" 1;;
2)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/two" 1;;
3)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/three" 1;;
4)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/four" 1;;
5)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/five" 1;;
6)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/six" 1;;
7)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/seven" 1;;
8)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/eight" 1;;
9)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/nine" 1;;
'#')
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/pound" 1;;
+)
	LongPressByAttributionWithoutUpdateXML "com.android.contacts:id/zero" 1;;
*)
	ClickByAttributionWithoutUpdateXML "com.android.contacts:id/star" 1;;
esac
